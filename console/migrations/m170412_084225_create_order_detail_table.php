 ...
 */
class m170412_084225_create_order_detail_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        $this->createTable('order_detail', [
            'id' => $this->primaryKey(),
            'order_info_id' => $this->integer(10)->unsigned()->notNull()->defaultValue(0)->comment('订单ID'),
            ...
            'price' => $this->integer(10)->unsigned()->notNull()->defaultValue(0)->comment('数量'),
