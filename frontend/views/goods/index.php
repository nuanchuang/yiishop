    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="<?=Yii::getAlias('@web')?>/images/preview_s1.jpg"></a>
                            </li>
                            <li>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="/cart/index" method="post" class="choose">
                    <ul>
