...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        ...
        <div class="address_bd mt10">
            ...
            echo $form->field($model,'province',['options'=>['tag'=>false,'template' => "{input}"]])->dropDownList([''=>'请选择'],['class'=>'txt','style'=>'width:87px'])->label(false);
            echo $form->field($model,'city',['options'=>['tag'=>false,'template' => "{input}"]])->dropDownList([''=>'请选择'],['class'=>'txt','style'=>'width:87px'])->label(false);
            echo $form->field($model,'area',['options'=>['tag'=>false,'template' => "{input}"]])->dropDownList([''=>'请选择'],['class'=>'txt','style'=>'width:87px'])->label(false);
            echo '</li>';
...
//////                'options' => ['tag'=>'label'],
////                'template' => "{label}$a\n{input}\n{hint}\n{error}"
//            )->checkbox(\frontend\models\Address::$status,['class'=>'check']);
            echo $form->field($model,'status',[
                'options' => ['tag'=>'li'],
            ])->checkbox(\frontend\models\Address::$status,['class'=>'check']);
...
$this->registerJs(new \yii\web\JsExpression(
    <<<EOT
            var options = '<option value="北京">北京</option>';
            $(address).each(function(){
                option += '<option>'+province.name+'</option>';
